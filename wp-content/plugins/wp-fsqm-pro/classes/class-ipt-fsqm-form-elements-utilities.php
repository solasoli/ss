...
class IPT_FSQM_Form_Elements_Utilities extends IPT_FSQM_Form_Elements_Base {
	...
	public function set_chart_type_n_toggles() {
		// Get the chart types
		$types = IPT_FSQM_Form_Elements_Static::get_chart_type_n_toggles();
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'ba-throttle-debounce', plugins_url( '/lib/js/jquery.ba-throttle-debounce.min.js', IPT_FSQM_Loader::$abs_file ), array( 'jquery' ), IPT_FSQM_Loader::$version );
		wp_enqueue_script( 'google-charts-loader', '//www.gstatic.com/charts/loader.js', array(), IPT_FSQM_Loader::$version );
		wp_enqueue_script( 'ipt-fsqm-report', plugins_url( '/static/common/js/jquery.ipt-fsqm-reports' . self::$js_suffix . '.js', IPT_FSQM_Loader::$abs_file ), array( 'jquery', 'google-charts-loader' ), IPT_FSQM_Loader::$version );
