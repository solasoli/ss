...
<div class="ipt-eform-stats" style="max-width: <?php echo esc_attr( $atts['width'] ); ?>px" data-stattype="submissions" data-charttype="bar" data-chartdata="<?php echo esc_attr( json_encode( $json ) ); ?>" data-chartoptions="<?php echo esc_attr( json_encode( $options ) ); ?>">
	...
	public function login_form( $atts, $content = null ) {
		...
		wp_enqueue_script( 'ipt-eform-login', plugins_url( '/static/front/js/jquery.ipt-eform-login.min.js', IPT_FSQM_Loader::$abs_file ), array( 'ipt-plugin-uif-front-js' ), IPT_FSQM_Loader::$version, true );
...
<div class="ipt_eform_login ipt_uif_front ipt_uif_common" data-ui-theme="<?php echo esc_attr( json_encode( $theme_element['include'] ) ); ?>" data-ui-theme-id="<?php echo esc_attr( $atts['theme'] ); ?>">
	...
	private function enqueue_stat_scripts() {
		...
		wp_enqueue_script( 'chart.js', plugins_url( '/lib/js/Chart.bundle.min.js', IPT_FSQM_Loader::$abs_file ), array( 'jquery' ), IPT_FSQM_Loader::$version, true );
		wp_enqueue_script( 'eform-form-stats', plugins_url( '/static/front/js/jquery.ipt-eform-form-stats.min.js', IPT_FSQM_Loader::$abs_file ), array( 'jquery', 'chart.js' ), IPT_FSQM_Loader::$version, true );
		wp_enqueue_style( 'eform-form-stats', plugins_url( '/static/front/css/ipt-eform-stats.css', IPT_FSQM_Loader::$abs_file ), array(), IPT_FSQM_Loader::$version );
	}
