...
;(function ( $, window, document, undefined ) {
	"use strict";
	var pluginName = "iptPluginUIFAdmin",
	defaults = {
		applyUIOnly: false,
		callback: null
	};
...
    // flattenedSource = [], flattenedSourceClass = [];
			...
			this.jElement.find('.ipt_uif_icon_selector').each(function() {
				...
				// Set the data
				elm.data( 'iptUIFiconPickerArgs', iconPickerArgs );
				...
				elm.data( 'iptUIFiconPickerDestroyed', iconPickerDestroyed );
			});
		},
		...
		initUIElementsDelegated: function() {
			...
			// Initialize the icon selector toggler
			this.edIconToggler();
		...
		// Icon toggler
		edIconToggler: function() {
			this.jElement.on( 'click', '.ipt_uif_fip_button', function(e) {
				e.preventDefault();
				var elm = $(this).prev('.ipt_uif_icon_selector'),
				iconPicker = null,
				iconPickerDestroyed = elm.data('iptUIFiconPickerDestroyed'),
				iconPickerArgs = elm.data('iptUIFiconPickerArgs'),
				iconToggler = $(this).find('button');
...
jQuery(document).ready(function($) {
	$('.ipt-eform-backoffice').iptPluginUIFAdmin();
