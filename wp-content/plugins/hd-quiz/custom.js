...
$hdQuJ("#hdQuestionnaireContent .jPaginate").first().remove();
$hdQuJ("#hdQuestionnaireContent .question").first().show();

$hdQuJ("#hdQuestionnaireContent").on("click", "#jPaginateNext", function() {
	$hdQuJ("#hdQuestionnaireContent .question").first().hide();
})