						...
						<div class="vq-content">
							<table class="form-table">
								<tbody>
									...
									<tr style="border-top:1px dashed #dedede;">
										<th scope="row">
											<?php _e("Show how many personalities when finished ?", 'wpvq'); ?>
										</th>
										<td>
											<label for="wpvq-multiplePersonalities">
												<input type="text" id="wpvq-multiplePersonalities" name="wpvqExtraOptions[multiplePersonalities]" value="<?php echo WPVQGame::getExtraOption($vqData['quizId'], 'multiplePersonalities', 1); ?>" style="width:40px; text-align:center;" />
												<?php _e("(order by score descending)", 'wpvq'); ?>
											</label>
										</td>
									</tr>
									<?php endif; ?>
									...
									<tr style="border-top:1px dashed #dedede;">
										...
										<td>
											<label for="wpvq-extraOptionSqueezePage">
												<input type="hidden" name="wpvqExtraOptions[squeezePage]" value="0" /> <!-- allowes uncheck -->
