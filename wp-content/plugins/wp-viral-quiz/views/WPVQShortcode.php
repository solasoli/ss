...
<?php if ($wpvq_squeeze_page): ?>
	<div id="wpvq-squeeze-<?php echo $quiz->getId(); ?>" class="wpvq-squeeze" style="display:none;">
		<button class="wpvq-start-quiz"><?php echo apply_filters('wpvq_start_quiz_label', __("Start the quiz!", 'wpvq')); ?></button>
	</div>
<?php endif ?>
	...
	<div id="wpvq-general-results">
		...
		<?php elseif ($quiz->getNiceType() == 'Personality'): ?>
			<div id="wpvq-final-personality">
				<span class="wpvq-quiz-title"><?php echo stripslashes($quiz->getName()); ?></span>
				<div id="wpvq-final-personality-lists">
...
<script type="text/javascript">
	...
	var wpvq_multiplePersonalities  = <?php echo intval($quiz->_getExtraOption('multiplePersonalities', 1)); ?>;
	...
	var wpvq_squeeze_page 			= <?php echo ($wpvq_squeeze_page) ? 'true':'false'; ?>;
