...
$output .= '</span>'."\n";
$output .='<input id="dhvc_form_control_'.$name.'" name="'.$name.'" class="dhvc-form-value dhvc-form-validate-extension dhvc-form-control-'.$name.' '.(!empty($required) ? ' dhvc-form-required-entry':'').'" type="file">';
